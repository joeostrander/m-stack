...
# 532 "../../../usb/include\\usb.h"
typedef void (*usb_ep0_data_stage_callback)(_Bool transfer_ok, void *context);
# 557 "../../../usb/include\\usb.h"
...
# 46 "../../../usb/include\\usb_ch9.h"
#pragma pack(push, 1)
# 63 "../../../usb/include\\usb_ch9.h"
enum PID {
 PID_OUT = 0x01,
 PID_IN = 0x09,
 PID_SOF = 0x05,
...
# 47 "../../../usb/include\\usb_hid.h"
#pragma pack(push, 1)
# 67 "../../../usb/include\\usb_hid.h"
...
# 278 "../usb_descriptors.c"
const struct configuration_descriptor *usb_application_config_descs[] =
{
 (struct configuration_descriptor*) &configuration_1,
};
typedef char STATIC_SIZE_CHECK_LINE_282 [((sizeof(usb_application_config_descs)/sizeof(*usb_application_config_descs))==1)?1:-1];
typedef char STATIC_SIZE_CHECK_LINE_283 [(sizeof(this_device_descriptor)==18)?1:-1];
